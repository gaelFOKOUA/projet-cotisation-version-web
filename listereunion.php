...
$query = "select * from réunion where id_reunion = " . $_SESSION["id_reunion"] . "";
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title"> Liste des reunion <a href="add_presence.html"><button type="button" class="btn btn-success mb-3">Selectionner une
                                        reunion</button></a>
                            </h4>
                        </div>
                            ...
                            <table class="table mb-0 table-borderless">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">montants_cotisation</th>
                                        <th scope="col">montants_presence</th>
                                        <th scope="col">bananiiere_r</th>
                     ...
                     listes de toutes les reunion
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row["montants_cotisation"]; ?></td>
                                            <td><?php echo $row["montants_presence"]; ?></td>
                                            <td><?php echo $row["bananiiere_r"]; ?></td>
