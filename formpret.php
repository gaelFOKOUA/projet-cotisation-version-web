            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <form id="form-wizard1" name="Banque" class="text-center mt-4" action="prets.php" method="post">
                            <ul id="top-tab-list" class="p-0">
                                <li class="active" id="account">
                                    <a href="javascript:void();">
                                        <i class="ri-lock-unlock-line"></i><span>Banques</span>
                                    </a>
                                </li>
                            ...
                            <fieldset>
                                <div class="form-card text-left">
                                    <div class="row">
                                        <div class="col-7">
                                            <h3 class="mb-4">Informations sur la banque:</h3>
                                        </div>
                                        <div class="col-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label>date pret: *</label>
                                            <input type="date" class="form-control" name="date_pret" placeholder="date pret" />
                                        </div>
                                        <div class="col-md-6">
                                            <label>date remboursement: *</label>
                                            <input type="date" class="form-control" name="date_rembour" placeholder="date remboursement" />
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <select class="form-control mb-3" name="pret">
                                                    <?php
                                                    ...
                                                    ?></select>
                                                    <select class="form-control mb-3" name="banque"> 
                                                    <?php

                                                    $query = "select * from banque";

                                                    $listeBanque = mysqli_query($dbconnect, $query);

                                                    while ($row = $listeBanque->fetch_assoc()) {
                                                    ?><option value="<?php echo $row["id_banque"]; ?>"><?php echo $row["nom"]; ?></option><?php
                                                                                        }
                                                                                            ?></select>
                                                                                             <select class="form-control mb-3" name="taux"> 
                                                    ...
                                                    ?><option value="<?php echo $row["id_taux"]; ?>"><?php echo $row["nom"]; ?></option><?php
                                                                                    }
