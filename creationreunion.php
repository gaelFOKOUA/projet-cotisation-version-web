            ...
            <div class="col-sm-12 col-lg-12">
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     <form id="form-wizard1" name="reunion" class="text-center mt-4" action="reunio.php" method="post">
                        <ul id="top-tab-list" class="p-0">
                           <li class="active" id="account">
                              <a href="javascript:void();">
                                 <i class="ri-lock-unlock-line"></i><span>Reunion</span>
                              </a>
                           </li>
                           <li id="personal">
                              <a href="javascript:void();">
                                 <i class="ri-user-fill"></i><span>Présence & cotisation</span>
                              </a>
                           </li>
                           <li id="payment">
                              <a href="javascript:void();">
                                 <i class="ri-camera-fill"></i><span>Logo </span>
                              </a>
                           </li>
                           <li id="confirm">
                              <a href="javascript:void();">
                        ...
                        <fieldset>
                           <div class="form-card text-left">
                              <div class="row">
                                 <div class="col-7">
                                    <h3 class="mb-4">Informations sur la reunion:</h3>
                                 </div>
                                 <div class="col-5">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group" acton>
                                       ...
                                       <input type="text" class="form-control" name="nom" placeholder="Nom de l'association" />
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                        ...
                        <fieldset>
                           <div class="form-card text-left">
                              <div class="row">
                                 <div class="col-7">
                                    <h3 class="mb-4">Montants a définir:</h3>
                                 </div>
                                 <div class="col-5">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label>montant_presence: *</label>
                                       <input type="number" class="form-control" name="montant_presence" placeholder="montant_presence" />
                                    </div>
                                 </div>
                               
                                 
                                 <div class="col-7">
                                    <h3 class="mb-4">Cotisation:</h3>
                                 </div>

                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label>montant_cotisation: *</label>
                                        <input type="number" class="form-control" name="montant_cotisation" placeholder="montant_cotisation" />
                                     </div>
                                 </div>
                        ...
                        <fieldset>
                           <div class="form-card text-left">
                              <div class="row">
                                 <div class="col-7">
                                    <h3 class="mb-4">Téléchargement d'image:</h3>
                                 </div>
                                 <div class="col-5">
                              ...
                              <div class="form-group">
                                 <label>Télécharger la banniere de l'association:</label>
