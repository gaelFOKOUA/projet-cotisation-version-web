                ...
                <div class="row m-0">
                    <div class="col-md-5 bg-white sign-in-page-data">
                        <div class="sign-in-from">
                            ...
                            <p class="text-center text-dark">Saisissez votre adresse électronique ,votre mot de passe et la fonction</p>
                            <form class="mt-4" action="recuperation.php" method="post">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Adresse Email</label>
                                    <input type="email" name="Email" class="form-control mb-0" id="exampleInputEmail1" placeholder="Saisir l'email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="d-inline-block w-100">
                                    <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                        ...
                                        <label class="custom-control-label" for="customCheck1">Souvenez-vous de moi</label>
                                    </div>
                                </div>
                                <div class="sign-info text-center">
                                    <button type="submit" class="btn btn-primary d-block w-100 mb-2">Connexion</button>
...
<!-- Mirrored from templates.iqonic.design/findash/html/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 31 Oct 2022 09:56:59 GMT -->
