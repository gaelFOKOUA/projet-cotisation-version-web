...
$query = "select * from cotisation where id_reunion = " . $_SESSION["id_reunion"] . "";
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title"> Liste des cotisation <a href="add_presence.html"><button type="button" class="btn btn-success mb-3">Selectionner une
                                        </button></a>
                            </h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless">
                                ...
                                <tbody>
                                 ...
                                 /* listes de toutes les cotisation
                                    $query = "select * from cotisation";

                                    $listeCotisation= mysqli_query($dbconnect, $query);

                                    while ($row = $listeCotisation->fetch_assoc()) {*/
                                    ?>
                                        <tr>
                                            <td>
                                                <div class="custom-control custom-checkbox text-center">
                                            ...
                                            <td><?php echo $row["date_cotisation"]; ?></td>
                                            <td>
