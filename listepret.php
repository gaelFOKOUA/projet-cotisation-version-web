...
$query = "select * from pret where id_reunion = " . $_SESSION["id_reunion"] . "";
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title"> Liste des prets <a href="add_presence.html"><button type="button" class="btn btn-success mb-3">Selectionner une
                                        pret</button></a>
                            </h4>
                        </div>
                            ...
                            <table class="table mb-0 table-borderless">
                                ...
                                <tbody>
                                  ...
                                  while ($row = $result->fetch_assoc()) {
                                    ...
                                    /*
                                    ceci céest pour afficher plusieurs pret dans la liste
                                    $query = "select * from pret";

                                    $listePret = mysqli_query($dbconnect, $query);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["date_rembour"]; ?></td>
