            ...
            <div class="col-sm-12 col-lg-12">
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     <form id="form-wizard1" name="Taux" class="text-center mt-4" action="tau.php" method="post">
                        <ul id="top-tab-list" class="p-0">
                           <li class="active" id="account">
                              <a href="javascript:void();">
                                 <i class="ri-lock-unlock-line"></i><span>Taux</span>
                              </a>
                           </li>
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group" acton>
                                       ...
                                       <input type="text" class="form-control" name="pourcentage" placeholder="pourcentage" />
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                 <label>duree: *</label>
                                       <input type="date" class="form-control" name="duree" placeholder="duree" />
                                 </div>
                                 <div class="col-md-6">
