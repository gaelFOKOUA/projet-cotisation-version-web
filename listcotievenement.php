...
$query = "select * from cotisevenement where id_reunion = " . $_SESSION["id_reunion"] . "";
                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title"> Liste des banques <a href="add_presence.html"><button type="button" class="btn btn-success mb-3">Selectionner une
                                        banque</button></a>
                            </h4>
                        </div>
                  ...
                  /* 
                  liste de tous les cotisations
                                    $query = "select * from cotisevenement";
