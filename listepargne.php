    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title"> Liste des epargnes<a href="add_presence.html"><button type="button" class="btn btn-success mb-3">Selectionner un epargnant
                                    </button></a>
                            </h4>
                        </div>
             ...
             /*
             listes de tous les epargne
                                    $query = "select * from epargne";

                                    $listeEpargne = mysqli_query($dbconnect, $query);

                                    while ($row = $listeEpargne->fetch_assoc()) {*/
                                    ?>
                                        <tr>
                                            <td>
                                                <div class="custom-control custom-checkbox text-center">
                                            ...
                                            <td><?php echo $row["date_epargne"]; ?></td>
                                            <td>
