                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Formulaire d'Evenements</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                        <form id="form-wizard1" name="Evenements" class="text-center mt-4" action="evenements.php" method="post">
                            <ul id="top-tab-list" class="p-0">
                                <li class="active" id="account">
                                    <a href="javascript:void();">
                                        <i class="ri-lock-unlock-line"></i><span>Evenements</span>
                                    </a>
                                </li>
                            ...
                            <fieldset>
                                <div class="form-card text-left">
                                    <div class="row">
                                        <div class="col-7">
                                            <h3 class="mb-4">Informations sur les Evenements:</h3>
                                        </div>
                                        <div class="col-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="date_evenement" placeholder="date_evenement" />
                                        </div>
                                        <div class="col-md-6">
                                            <label>type_evenement: *</label>
                                            <input type="text" class="form-control" name="type_evenement" placeholder="type_evenement" />
                                        </div>
                                        <div class="col-md-6">
