                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            <form id="form-wizard1" name="Banque" class="text-center mt-4" action="cotievenement.php" method="post">
                                <ul id="top-tab-list" class="p-0">
                                    <li class="active" id="account">
                                        <a href="javascript:void();">
                                            <i class="ri-lock-unlock-line"></i><span>Cotisation d'évenement</span>
                                        </a>
                                    </li>
                                ...
                                <fieldset>
                                    <div class="form-card text-left">
                                        <div class="row">
                                            <div class="col-7">
                                                <h3 class="mb-4">Informations sur la cotisation d'évenement:</h3>
                                            </div>
                                            <div class="col-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <select class="form-control mb-3" name="evenement">
                                                        <?php
                                                            ...
                                                            while($row = $listeEvenement->fetch_assoc()) {
                                                                ?><option value="<?php echo $row["id_evenement"];?>"><?php echo $row["nom"];?></option><?php
                                                            }
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control mb-3" name="membres">
                                                        <?php
                                                            ...
                                                            while($row = $listeReunion->fetch_assoc()) {
                                                                ?><option value="<?php echo $row["id_membre"];?>"><?php  echo $row["nom"]." ".$row["prenom"];?></option><?php
                                                            }
