                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <script>
                                                    ...
                                                    function verif(){
                                                        ...
                                                        while (telephone.length != 9 || telephone[0] != 6 && verif) {
                                                            alert("Numero de telephone erroné !!!");
                                                            verif = true;
                                                        }
                                                    }
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control mb-3" name="fonction">
                                                    ...
                                                    <option value="Sécrétaire">adherent</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="numero_CNI" placeholder="numero_CNI." />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>date_jour': *</label>
                                                <input type="date" class="form-control" name="date_jour'" placeholder="date_jour'." />
                                            </div>
                                        </div>

                                    </div>
                                </div>
                                <button type="button" name="next" onclick="verif();" class="btn btn-primary next action-button float-right" value="Next">Suivant</button>
