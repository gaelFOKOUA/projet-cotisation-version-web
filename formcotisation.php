                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Formulaire d'Inscription cotisation</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <form id="form-wizard1" name="Cotisation" class="text-center mt-4" action="cotisation.php" method="post">
                                <ul id="top-tab-list" class="p-0">
                                    <li class="active" id="account">
                                        <a href="javascript:void();">
                                            <i class="ri-lock-unlock-line"></i><span>cotisation</span>
                                        </a>
                                    </li>
                                ...
                                <fieldset>
                                    <div class="form-card text-left">
                                        <div class="row">
                                            <div class="col-7">
                                                <h3 class="mb-4">Informations sur la cotisation:</h3>
                                            </div>
                                            <div class="col-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control mb-3" name="membres">
                                                        <?php
                                                            ...
                                                            $listeMembres = mysqli_query($dbconnect, $query);

                                                            while($row = $listeMembres->fetch_assoc()) {
